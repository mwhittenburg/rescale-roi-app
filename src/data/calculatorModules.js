...
import { infrastructureTco } from "../calculators/it/burst-capacity-overflow";
import { peakCapacityTco } from "../calculators/it/governance-standardization";
import { itOperationsTco } from "../calculators/it/it-operations-efficiency";
...
export const calculatorModules = {
  ...
  "it/infrastructure-tco": infrastructureTco,
  "it/peak-capacity-tco": peakCapacityTco,
  "it/it-operations-tco": itOperationsTco,
};
